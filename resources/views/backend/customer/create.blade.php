                ...
                <div class="row">
                    ...
                    <section class="col-md-12 connectedSortable">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <ul class="nav nav-pills ml-auto">
                                        <li class="nav-item">
                                            <a class="btn btn-success btn-sm" href="{{ route('customer.view') }}"> <i
                                                    class="fa fa-list"></i> Customer List</a>
                                        </li>
                            ...
                            <div class="card-body">
                                <form action="{{ (@$editData) ? route('customer.update', $editData->id) : route('customer.store') }}" method="POST" role="form" id="myForm">
                                    @csrf
                                    <div class="form-row">
