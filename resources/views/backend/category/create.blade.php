                ...
                <div class="row">
                    ...
                    <section class="col-md-12 connectedSortable">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <ul class="nav nav-pills ml-auto">
                                        <li class="nav-item">
                                            <a class="btn btn-success btn-sm" href="{{ route('category.view') }}"> <i
                            ...
                            <div class="card-body">
                                <form action="{{ (@$editData) ? route('category.update', $editData->id) : route('category.store') }}" method="POST" role="form" id="myForm">
                                    @csrf
                                    <div class="form-row">
