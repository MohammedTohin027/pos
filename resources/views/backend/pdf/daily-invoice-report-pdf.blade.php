...
<body>
    ...
    <div class="container">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                    <span><p style="text-align: center; margin-bottom: 10px;"><strong>Daily Invoice Report ({{ date('d-M Y', strtotime($start_date)) }} - {{ date('d-M Y', strtotime($end_date)) }})</strong></p></span>
                </div>
            </div>
        </div>
